            ...
            <form id="loginForm" method="post" action="retrievePassWordServlet">
                <table>
                    ...
                    <tr>
                        ...
                        <td><input class="text" type="text" id="uName" name="uName" onfocus="FocusItem(this)"
                                   onblur="CheckItem(this);"/><span></span></td>
                    </tr>
                    <tr>
                        <td class="field">邮箱：</td>
                        <td><input class="text" type="text" id="remail" name="remail" onfocus="FocusItem(this)"
                                   onblur="CheckItem(this);"/><span id="uemail"></span></td>
                    </tr>
                    <tr>
                        <td class="field">新密码：</td>
                        <td><input class="text" type="text" style="display: none;" id="newpwd" name="newpwd"
