...
<head>
    ...
    <title>Shinning-Home page</title>
    ...
    <c:if test="${empty sessionScope.mclassList}">
        <jsp:forward page="/user/goods?method=goodsCategory"/>
    </c:if>
</head>
<body> <!-- onload="indexBodyaj1()" -->
<input type="hidden" name="method" value="goodsCategory"/>
